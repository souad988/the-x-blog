...
# 📖 [X-BLOG] <a name="about-project"></a>

**[X-BLOG]** is a web application where users can share posts and others can read them add comment and likes to, built using Rails framework. 
